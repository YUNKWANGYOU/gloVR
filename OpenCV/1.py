...
global status
global UDP_IP,UDP_PORT,UDP_PORT2
global pyToUnity, unityToPy
global cap,cap2
global cxcyCount,cxcyCount2

def initUDP() :
    global UDP_IP,UDP_PORT,UDP_PORT2,pyToUnity, unityToPy
    UDP_IP = "127.0.0.1"
    UDP_PORT = 5065
    UDP_PORT2 = 8000
    pyToUnity = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    unityToPy = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    pyToUnity.bind((UDP_IP,UDP_PORT))
    unityToPy.bind((UDP_IP,UDP_PORT2))
